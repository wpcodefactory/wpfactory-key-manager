...
= 1.5.7 - 12/02/2024 =
* Fix - Failed to open stream in class-alg-wpfkm.php on line 160.

= 1.5.6 - 07/12/2023 =
* Fix "PHP Deprecated:  Automatic conversion of false to array is deprecated in wpfkm-site-key-functions.php".
...
= 1.4.0 - 28/10/2022 =
* Dev - `download_url()` function removed from the `wpfkm_get_plugins_list` and `wpfkm_get_themes_list` actions.
...
= 1.2.0 - 02/10/2017 =
* Dev - `wpfkm_update_site_key_status()` - Don't overwrite valid licence response with server errors (no response etc.).
...
= 1.0.1 - 22/08/2017 =
* Fix - `WPFKM_UPDATE_SERVER` constant added.
