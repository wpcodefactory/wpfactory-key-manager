...
if ( !class_exists(PluginUpdateChecker::class, false) ):
	...
	class PluginUpdateChecker extends Plugin\UpdateChecker implements BaseChecker {
		...
		public function requestInfo($unusedParameter = null) {
			...
			//Try parsing CHANGELOG.md. If it's formatted according to WordPress.org standards, it will contain
		...
		/**
		 * Check if the currently installed version has a CHANGELOG.md file.
		 *
		 * @return bool
		 */
		...
		/**
		 * Copy plugin metadata from the remote CHANGELOG.md file.
		 *
